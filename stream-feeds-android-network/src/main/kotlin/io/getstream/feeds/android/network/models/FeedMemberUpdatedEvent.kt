...
public data class FeedMemberUpdatedEvent(
    @Json(name = "created_at") public val createdAt: java.util.Date,
    @Json(name = "fid") public val fid: kotlin.String,
    @Json(name = "custom")
    public val custom: kotlin.collections.Map<kotlin.String, Any?> = emptyMap(),
    @Json(name = "member")
    public val member: io.getstream.feeds.android.network.models.FeedMemberResponse,
    @Json(name = "type") public val type: kotlin.String = "feeds.feed_member.updated",
