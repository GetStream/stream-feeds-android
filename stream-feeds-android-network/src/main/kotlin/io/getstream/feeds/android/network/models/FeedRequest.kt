...
/**  */
public data class FeedRequest(
    @Json(name = "feed_group_id") public val feedGroupId: kotlin.String,
    @Json(name = "feed_id") public val feedId: kotlin.String,
    @Json(name = "created_by_id") public val createdById: kotlin.String? = null,
