...
public data class FeedGroupChangedEvent(
    ...
    @Json(name = "feed_group")
    public val feedGroup: io.getstream.feeds.android.network.models.FeedGroup? = null,
    @Json(name = "user")
