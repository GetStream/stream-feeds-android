...
public data class ActivityUnpinnedEvent(
    ...
    public val pinnedActivity: io.getstream.feeds.android.network.models.PinActivityResponse,
    @Json(name = "type") public val type: kotlin.String = "feeds.activity.unpinned",
