...
public data class ActionLog(
    ...
    @Json(name = "reporter_type") public val reporterType: kotlin.String,
    @Json(name = "review_queue_item_id") public val reviewQueueItemId: kotlin.String,
    @Json(name = "target_user_id") public val targetUserId: kotlin.String,
    @Json(name = "type") public val type: kotlin.String,
    @Json(name = "custom")
    public val custom: kotlin.collections.Map<kotlin.String, Any?> = emptyMap(),
    @Json(name = "review_queue_item")
    public val reviewQueueItem: io.getstream.feeds.android.network.models.ReviewQueueItem? = null,
    @Json(name = "target_user")
    public val targetUser: io.getstream.feeds.android.network.models.User? = null,
