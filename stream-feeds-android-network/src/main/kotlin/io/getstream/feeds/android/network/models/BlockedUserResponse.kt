...
/**  */
public data class BlockedUserResponse(
    @Json(name = "blocked_user_id") public val blockedUserId: kotlin.String,
    ...
    public val blockedUser: io.getstream.feeds.android.network.models.UserResponse,
