...
public data class Flag(
    ...
    @Json(name = "is_streamed_content") public val isStreamedContent: kotlin.Boolean? = null,
    @Json(name = "moderation_payload_hash") public val moderationPayloadHash: kotlin.String? = null,
