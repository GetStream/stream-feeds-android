...
public data class Poll(
    ...
    public val latestAnswers:
        kotlin.collections.List<io.getstream.feeds.android.network.models.PollVote> =
        emptyList(),
    @Json(name = "options")
    public val options:
        kotlin.collections.List<io.getstream.feeds.android.network.models.PollOption> =
        emptyList(),
    @Json(name = "own_votes")
    public val ownVotes:
        kotlin.collections.List<io.getstream.feeds.android.network.models.PollVote> =
    ...
    @Json(name = "voting_visibility") public val votingVisibility: kotlin.String? = null,
