...
/**  */
public data class ChannelConfigWithInfo(
    ...
    @Json(name = "commands")
    public val commands:
        kotlin.collections.List<io.getstream.feeds.android.network.models.Command> =
        emptyList(),
    ...
    @Json(name = "partition_ttl") public val partitionTtl: kotlin.String? = null,
