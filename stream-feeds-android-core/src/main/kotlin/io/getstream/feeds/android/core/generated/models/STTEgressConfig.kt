...
data class STTEgressConfig(
    @Json(name = "closed_captions_enabled") val closedCaptionsEnabled: kotlin.Boolean? = null,
    @Json(name = "language") val language: kotlin.String? = null,
    @Json(name = "storage_name") val storageName: kotlin.String? = null,
    @Json(name = "translations_enabled") val translationsEnabled: kotlin.Boolean? = null,
    @Json(name = "upload_transcriptions") val uploadTranscriptions: kotlin.Boolean? = null,
    @Json(name = "whisper_server_base_url") val whisperServerBaseUrl: kotlin.String? = null,
