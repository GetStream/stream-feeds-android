...
data class EntityCreatorResponse (
    @Json(name = "ban_count")
    val banCount: kotlin.Int,
    ...
    @Json(name = "deleted_content_count")
    val deletedContentCount: kotlin.Int,

    @Json(name = "flagged_count")
    val flaggedCount: kotlin.Int,
