...
data class Flag(
    ...
    @Json(name = "is_streamed_content") val isStreamedContent: kotlin.Boolean? = null,
    @Json(name = "moderation_payload_hash") val moderationPayloadHash: kotlin.String? = null,
    @Json(name = "reason") val reason: kotlin.String? = null,
    @Json(name = "review_queue_item_id") val reviewQueueItemId: kotlin.String? = null,
    @Json(name = "type") val type: kotlin.String? = null,
    @Json(name = "labels") val labels: kotlin.collections.List<kotlin.String>? = emptyList(),
