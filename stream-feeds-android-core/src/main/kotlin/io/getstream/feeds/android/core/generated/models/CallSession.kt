...
data class CallSession (
    @Json(name = "AnonymousParticipantCount")
    ...
    val activeSFUs: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.SFUIDLastSeen> = emptyList(),

    @Json(name = "Participants")
    val participants: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.CallParticipant> = emptyList(),

    @Json(name = "SFUIDs")
    val sFUIDs: kotlin.collections.List<kotlin.String> = emptyList(),
    ...
    val userPermissionOverrides: kotlin.collections.Map<kotlin.String, kotlin.collections.Map<kotlin.String, kotlin.Boolean>> = emptyMap(),
