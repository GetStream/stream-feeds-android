...
data class Device(
    ...
    @Json(name = "push_provider") val pushProvider: PushProvider,
    @Json(name = "user_id") val userId: kotlin.String,
    @Json(name = "disabled") val disabled: kotlin.Boolean? = null,
    @Json(name = "disabled_reason") val disabledReason: kotlin.String? = null,
    @Json(name = "push_provider_name") val pushProviderName: kotlin.String? = null,
    @Json(name = "voip") val voip: kotlin.Boolean? = null,
) {
    ...
    sealed class PushProvider(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): PushProvider =
                when (s) {
                    "apn" -> Apn
                    "firebase" -> Firebase
                    "huawei" -> Huawei
