...
data class Call(
    ...
    @Json(name = "Backstage") val backstage: kotlin.Boolean,
    @Json(name = "CID") val cID: kotlin.String,
    @Json(name = "ChannelCID") val channelCID: kotlin.String,
    @Json(name = "CreatedAt") val createdAt: org.threeten.bp.OffsetDateTime,
    @Json(name = "CreatedByUserID") val createdByUserID: kotlin.String,
    @Json(name = "CurrentSessionID") val currentSessionID: kotlin.String,
    @Json(name = "ID") val iD: kotlin.String,
    @Json(name = "LastSessionID") val lastSessionID: kotlin.String,
    @Json(name = "Team") val team: kotlin.String,
    @Json(name = "ThumbnailURL") val thumbnailURL: kotlin.String,
    ...
    val blockedUsers:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.User> =
        emptyList(),
    @Json(name = "Egresses")
    val egresses:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.CallEgress> =
        emptyList(),
    @Json(name = "Members")
    val members:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.CallMember> =
        emptyList(),
    ...
    @Json(name = "EgressUpdatedAt") val egressUpdatedAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "EndedAt") val endedAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "JoinAheadTimeSeconds") val joinAheadTimeSeconds: kotlin.Int? = null,
    @Json(name = "LastHeartbeatAt") val lastHeartbeatAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "MemberCount") val memberCount: kotlin.Int? = null,
    @Json(name = "StartsAt") val startsAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "CallType")
