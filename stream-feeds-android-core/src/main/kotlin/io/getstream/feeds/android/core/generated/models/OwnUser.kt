...
data class OwnUser(
    ...
    val channelMutes:
        ...
        emptyList(),
    @Json(name = "devices")
    val devices: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.Device> =
        emptyList(),
    @Json(name = "mutes")
    val mutes: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.UserMute> =
        emptyList(),
