...
data class UserBannedEvent(
    @Json(name = "channel_id") val channelId: kotlin.String,
    @Json(name = "channel_type") val channelType: kotlin.String,
    ...
    @Json(name = "created_by") val createdBy: io.getstream.feeds.android.core.generated.models.User,
    @Json(name = "type") val type: kotlin.String,
    @Json(name = "expiration") val expiration: org.threeten.bp.OffsetDateTime? = null,
