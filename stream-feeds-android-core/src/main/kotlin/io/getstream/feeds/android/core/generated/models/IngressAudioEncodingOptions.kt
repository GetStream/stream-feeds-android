...
/**  */
data class IngressAudioEncodingOptions(
    @Json(name = "bitrate") val bitrate: kotlin.Int,
    @Json(name = "channels") val channels: Channels,
    @Json(name = "enable_dtx") val enableDtx: kotlin.Boolean,
) {
    ...
    sealed class Channels(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): Channels =
                when (s) {
                    "1" -> `1`
                    "2" -> `2`
                    else -> Unknown(s)
