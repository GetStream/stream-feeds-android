...
data class Poll (
    ...
    val latestAnswers: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollVote> = emptyList(),

    @Json(name = "options")
    val options: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollOption> = emptyList(),

    @Json(name = "own_votes")
    val ownVotes: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollVote> = emptyList(),

    @Json(name = "Custom")
    val custom: kotlin.collections.Map<kotlin.String, Any?> = emptyMap(),

    @Json(name = "latest_votes_by_option")
    val latestVotesByOption: kotlin.collections.Map<kotlin.String, kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollVote>> = emptyMap(),
    ...
    val votingVisibility: kotlin.String? = null,
