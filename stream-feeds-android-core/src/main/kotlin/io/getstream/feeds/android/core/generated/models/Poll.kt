...
data class Poll(
    ...
    val latestAnswers:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollVote> =
        emptyList(),
    @Json(name = "options")
    val options:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollOption> =
        emptyList(),
    @Json(name = "own_votes")
    val ownVotes:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.PollVote> =
    ...
    @Json(name = "voting_visibility") val votingVisibility: kotlin.String? = null,
