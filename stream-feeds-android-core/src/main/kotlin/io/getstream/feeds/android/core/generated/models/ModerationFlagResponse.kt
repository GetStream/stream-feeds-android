...
data class ModerationFlagResponse(
    @Json(name = "created_at") val createdAt: kotlin.String,
    ...
    @Json(name = "updated_at") val updatedAt: kotlin.String,
    ...
    val reviewQueueItem: io.getstream.feeds.android.core.generated.models.ReviewQueueItemResponse? =
        null,
    @Json(name = "user")
