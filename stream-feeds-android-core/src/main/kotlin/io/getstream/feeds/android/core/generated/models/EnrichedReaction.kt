...
data class EnrichedReaction (
    ...
    val latestChildren: kotlin.collections.Map<kotlin.String, kotlin.collections.List<io.getstream.feeds.android.core.generated.models.EnrichedReaction>>? = emptyMap(),

    @Json(name = "own_children")
    val ownChildren: kotlin.collections.Map<kotlin.String, kotlin.collections.List<io.getstream.feeds.android.core.generated.models.EnrichedReaction>>? = emptyMap(),

    @Json(name = "updated_at")
    val updatedAt: io.getstream.feeds.android.core.generated.models.Time? = null,

    @Json(name = "user")
    val user: io.getstream.feeds.android.core.generated.models.Data? = null
)
