...
data class ReviewQueueItemResponse(
    ...
    val actions:
        kotlin.collections.List<
            io.getstream.feeds.android.core.generated.models.ActionLogResponse
        > =
        emptyList(),
    @Json(name = "bans")
    ...
    val flags:
        kotlin.collections.List<
            io.getstream.feeds.android.core.generated.models.ModerationFlagResponse
        > =
        emptyList(),
    @Json(name = "languages") val languages: kotlin.collections.List<kotlin.String> = emptyList(),
    @Json(name = "completed_at") val completedAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "config_key") val configKey: kotlin.String? = null,
    @Json(name = "entity_creator_id") val entityCreatorId: kotlin.String? = null,
    @Json(name = "reviewed_at") val reviewedAt: org.threeten.bp.OffsetDateTime? = null,
    ...
    val entityCreator: io.getstream.feeds.android.core.generated.models.EntityCreatorResponse? =
        null,
