...
data class ReviewQueueItem (
    ...
    @Json(name = "bounce_count")
    val bounceCount: kotlin.Int,

    @Json(name = "config_key")
    val configKey: kotlin.String,

    @Json(name = "content_changed")
    ...
    val moderationPayloadHash: kotlin.String,
    ...
    @Json(name = "actions")
    val actions: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.ActionLog> = emptyList(),
    ...
    @Json(name = "flags")
    val flags: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.Flag> = emptyList(),
    ...
    @Json(name = "call")
    val call: io.getstream.feeds.android.core.generated.models.Call? = null,
