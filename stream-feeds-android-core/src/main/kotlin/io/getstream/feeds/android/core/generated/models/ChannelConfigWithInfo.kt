...
data class ChannelConfigWithInfo(
    @Json(name = "automod") val automod: Automod,
    @Json(name = "automod_behavior") val automodBehavior: AutomodBehavior,
    @Json(name = "connect_events") val connectEvents: kotlin.Boolean,
    @Json(name = "created_at") val createdAt: org.threeten.bp.OffsetDateTime,
    @Json(name = "custom_events") val customEvents: kotlin.Boolean,
    @Json(name = "mark_messages_pending") val markMessagesPending: kotlin.Boolean,
    @Json(name = "max_message_length") val maxMessageLength: kotlin.Int,
    @Json(name = "mutes") val mutes: kotlin.Boolean,
    @Json(name = "name") val name: kotlin.String,
    @Json(name = "polls") val polls: kotlin.Boolean,
    @Json(name = "push_notifications") val pushNotifications: kotlin.Boolean,
    @Json(name = "quotes") val quotes: kotlin.Boolean,
    @Json(name = "reactions") val reactions: kotlin.Boolean,
    @Json(name = "read_events") val readEvents: kotlin.Boolean,
    @Json(name = "reminders") val reminders: kotlin.Boolean,
    @Json(name = "replies") val replies: kotlin.Boolean,
    @Json(name = "search") val search: kotlin.Boolean,
    @Json(name = "shared_locations") val sharedLocations: kotlin.Boolean,
    @Json(name = "skip_last_msg_update_for_system_msgs")
    val skipLastMsgUpdateForSystemMsgs: kotlin.Boolean,
    @Json(name = "typing_events") val typingEvents: kotlin.Boolean,
    @Json(name = "updated_at") val updatedAt: org.threeten.bp.OffsetDateTime,
    @Json(name = "uploads") val uploads: kotlin.Boolean,
    @Json(name = "url_enrichment") val urlEnrichment: kotlin.Boolean,
    @Json(name = "user_message_reminders") val userMessageReminders: kotlin.Boolean,
    @Json(name = "commands")
    val commands:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.Command> =
        emptyList(),
    @Json(name = "blocklist") val blocklist: kotlin.String? = null,
    @Json(name = "blocklist_behavior") val blocklistBehavior: BlocklistBehavior? = null,
    @Json(name = "partition_size") val partitionSize: kotlin.Int? = null,
    @Json(name = "partition_ttl") val partitionTtl: kotlin.String? = null,
    ...
    val blocklists:
        kotlin.collections.List<
            io.getstream.feeds.android.core.generated.models.BlockListOptions
        >? =
        emptyList(),
    ...
    sealed class Automod(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): Automod =
                when (s) {
                    "AI" -> AI
                    "disabled" -> Disabled
                    "simple" -> Simple
    ...
    sealed class BlocklistBehavior(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): BlocklistBehavior =
                when (s) {
                    "block" -> Block
                    "flag" -> Flag
                    "shadow_block" -> ShadowBlock
