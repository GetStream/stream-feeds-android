...
data class ThreadedCommentResponse(
    @Json(name = "confidence_score") val confidenceScore: kotlin.Float,
    @Json(name = "created_at") val createdAt: org.threeten.bp.OffsetDateTime,
    @Json(name = "downvote_count") val downvoteCount: kotlin.Int,
    ...
    @Json(name = "controversy_score") val controversyScore: kotlin.Float? = null,
    ...
    val replies:
        kotlin.collections.List<
            io.getstream.feeds.android.core.generated.models.ThreadedCommentResponse
        >? =
        emptyList(),
