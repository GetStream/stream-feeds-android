...
data class VideoSettings(
    ...
    @Json(name = "camera_default_on") val cameraDefaultOn: kotlin.Boolean,
    @Json(name = "camera_facing") val cameraFacing: CameraFacing,
    @Json(name = "enabled") val enabled: kotlin.Boolean,
    @Json(name = "target_resolution")
    val targetResolution: io.getstream.feeds.android.core.generated.models.TargetResolution,
) {
    ...
    sealed class CameraFacing(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): CameraFacing =
                when (s) {
                    "back" -> Back
                    "external" -> External
                    "front" -> Front
