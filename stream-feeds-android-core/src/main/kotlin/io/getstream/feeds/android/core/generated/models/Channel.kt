...
data class Channel (
    ...
    val autoTranslationLanguage: kotlin.String,
    ...
    @Json(name = "last_campaigns")
    val lastCampaigns: kotlin.String? = null,
    ...
    val activeLiveLocations: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.SharedLocation>? = emptyList(),

    @Json(name = "invites")
    val invites: kotlin.collections.List<io.getstream.feeds.android.core.generated.models.ChannelMember>? = emptyList(),
