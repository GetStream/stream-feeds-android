...
data class UpsertConfigRequest(
    ...
    val automodPlatformCircumventionConfig:
        io.getstream.feeds.android.core.generated.models.AutomodPlatformCircumventionConfig? =
        null,
    @Json(name = "automod_semantic_filters_config")
    val automodSemanticFiltersConfig:
        io.getstream.feeds.android.core.generated.models.AutomodSemanticFiltersConfig? =
        null,
    @Json(name = "automod_toxicity_config")
    val automodToxicityConfig:
        io.getstream.feeds.android.core.generated.models.AutomodToxicityConfig? =
        null,
    @Json(name = "aws_rekognition_config")
    val awsRekognitionConfig: io.getstream.feeds.android.core.generated.models.AIImageConfig? =
        null,
    ...
    val googleVisionConfig: io.getstream.feeds.android.core.generated.models.GoogleVisionConfig? =
        null,
    ...
    val ruleBuilderConfig: io.getstream.feeds.android.core.generated.models.RuleBuilderConfig? =
        null,
    @Json(name = "velocity_filter_config")
    val velocityFilterConfig:
        io.getstream.feeds.android.core.generated.models.VelocityFilterConfig? =
        null,
    @Json(name = "video_call_rule_config")
    val videoCallRuleConfig: io.getstream.feeds.android.core.generated.models.VideoCallRuleConfig? =
        null,
)
