...
data class FullUserResponse(
    ...
    @Json(name = "invisible") val invisible: kotlin.Boolean,
    ...
    @Json(name = "total_unread_count") val totalUnreadCount: kotlin.Int,
    @Json(name = "unread_channels") val unreadChannels: kotlin.Int,
    @Json(name = "unread_count") val unreadCount: kotlin.Int,
    @Json(name = "unread_threads") val unreadThreads: kotlin.Int,
    ...
    val channelMutes:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.ChannelMute> =
        emptyList(),
    @Json(name = "devices")
    val devices:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.DeviceResponse> =
        emptyList(),
    @Json(name = "mutes")
    val mutes:
        kotlin.collections.List<io.getstream.feeds.android.core.generated.models.UserMuteResponse> =
        emptyList(),
