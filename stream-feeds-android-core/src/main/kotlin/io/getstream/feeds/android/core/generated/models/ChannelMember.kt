...
data class ChannelMember(
    ...
    @Json(name = "channel_role") val channelRole: kotlin.String,
    @Json(name = "created_at") val createdAt: org.threeten.bp.OffsetDateTime,
    @Json(name = "notifications_muted") val notificationsMuted: kotlin.Boolean,
    @Json(name = "shadow_banned") val shadowBanned: kotlin.Boolean,
    ...
    @Json(name = "archived_at") val archivedAt: org.threeten.bp.OffsetDateTime? = null,
    ...
    @Json(name = "invite_accepted_at") val inviteAcceptedAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "invite_rejected_at") val inviteRejectedAt: org.threeten.bp.OffsetDateTime? = null,
    @Json(name = "invited") val invited: kotlin.Boolean? = null,
    @Json(name = "is_moderator") val isModerator: kotlin.Boolean? = null,
    ...
    sealed class Role(val value: kotlin.String) {
        ...
        companion object {
            fun fromString(s: kotlin.String): Role =
                when (s) {
                    "admin" -> Admin
                    "member" -> Member
                    "moderator" -> Moderator
