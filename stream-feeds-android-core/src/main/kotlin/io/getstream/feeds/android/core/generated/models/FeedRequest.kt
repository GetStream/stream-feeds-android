...
data class FeedRequest(
    @Json(name = "feed_group_id") val feedGroupId: kotlin.String,
    @Json(name = "feed_id") val feedId: kotlin.String,
    @Json(name = "created_by_id") val createdById: kotlin.String? = null,
