...
import io.getstream.feeds.android.client.api.state.MembersSort
 ...
 */
internal class MemberListStateImpl(
    ...
    override fun onMembersUpdated(updates: ModelUpdates<FeedMemberData>) {
        ...
        _members.value = _members.value.filterNot { member ->
            member.id in updates.removedIds
        }
    }
 ...
 *
 * This interface defines methods for updating the member list when new members are queried,
 * members are removed, or members are updated. It also provides a method to clear the state.
 */
