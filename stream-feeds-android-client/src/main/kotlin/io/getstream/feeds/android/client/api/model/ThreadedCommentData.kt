 ...
 *
 * This struct contains all the information about a comment with threaded replies, including its
 * content, metadata, reactions, nested replies, and user information. It supports hierarchical
 * comment structures with pagination metadata.
 *
 * ## Features:
 ...
 *   rich media comments.
 * @property bookmarkCount The number of bookmarks this comment has received.
 ...
 *   has been deleted, this property contains the deletion timestamp. If the comment is still
 *   active, this property is `null`.
 * @property downvoteCount The number of downvotes received by the comment.
 * @property editedAt The date and time when the comment was last edited, if applicable.
 ...
 *   the latest reactions from users, typically limited to the most recent ones to keep the data
 *   size manageable.
 ...
 *   to another comment, this property contains the ID of the parent comment. For top-level
 *   comments, this is `null`.
 ...
 *   typically used for sorting or ranking comments based on various factors like relevance,
...
public data class ThreadedCommentData(
     ...
     *
     * This constructor converts a regular comment to a threaded comment, preserving all the comment
     * data while adding support for threaded replies.
     */
    public constructor(
        comment: CommentData
    ) : this(
