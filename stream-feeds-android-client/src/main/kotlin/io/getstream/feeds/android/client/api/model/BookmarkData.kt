...
import io.getstream.feeds.android.core.generated.models.BookmarkResponse
 ...
 * metadata, folder organization, and user information. Bookmarks allow users to save and
 * organize activities for later reference.
 *
 * Features:
 ...
 * additional metadata or custom fields specific to your application's bookmark functionality.
 * It may be `null` if no custom data is associated with the bookmark.
 * @property folder The bookmark folder this bookmark belongs to, if any. This property allows
 * for organizing bookmarks into folders or collections. If the bookmark is not organized into
 * a folder, this property is `null`.
 * @property updatedAt The date and time when the bookmark was last updated.
 * @property user The user who created the bookmark. This property contains the full user data
 * for the user who bookmarked the activity.
 */
 ...
 */
internal fun BookmarkResponse.toModel(): BookmarkData = BookmarkData(
