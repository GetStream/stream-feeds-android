...
public typealias FeedsFilter = TypedFilter<FeedsFilterField>

public interface FeedsFilterField : FilterField {
    /**
     * Filter by feed ID.
     *
     * Supported operators: `equal`, `in`
     */
    public data object Id : FeedsFilterField, DefaultFilterField("id")
     ...
     * Supported operators: `equal`, `in`
     */
    public data object GroupId : FeedsFilterField, DefaultFilterField("group_id")
     ...
     * Supported operators: `equal`, `in`
     */
    public data object Feed : FeedsFilterField, DefaultFilterField("feed")
     ...
     */
    public data object CreatedAt : FeedsFilterField, DefaultFilterField("created_at")
     ...
     * Supported operators: `equal`, `in`
     */
    public data object CreatedById : FeedsFilterField, DefaultFilterField("created_by_id")
     ...
     */
    public data object CreatedByName : FeedsFilterField, DefaultFilterField("created_by.name")
     ...
     * Supported operators: `equal`, `q`, `autocomplete`
     */
    public data object Description : FeedsFilterField, DefaultFilterField("description")
     ...
     * Supported operators: `equal`, `greater`, `greaterOrEqual`, `less`, `lessOrEqual`
     */
    public data object FollowerCount : FeedsFilterField, DefaultFilterField("follower_count")
     ...
     * Supported operators: `equal`, `greater`, `greaterOrEqual`, `less`, `lessOrEqual`
     */
    public data object FollowingCount : FeedsFilterField, DefaultFilterField("following_count")
     ...
     * Supported operators: `equal`, `greater`, `greaterOrEqual`, `less`, `lessOrEqual`
     */
    public data object MemberCount : FeedsFilterField, DefaultFilterField("member_count")
     ...
     */
    public data object Members : FeedsFilterField, DefaultFilterField("members")
     ...
     * Supported operators: `equal`, `q`, `autocomplete`
     */
    public data object Name : FeedsFilterField, DefaultFilterField("name")
     ...
     * Supported operators: `equal`, `greater`, `greaterOrEqual`, `less`, `lessOrEqual`
     */
    public data object UpdatedAt : FeedsFilterField, DefaultFilterField("updated_at")
     ...
     * Supported operators: `equal`, `in`
     */
    public data object Visibility : FeedsFilterField, DefaultFilterField("visibility")
     ...
     * Supported operators: `in`
     */
    public data object FollowingUsers : FeedsFilterField, DefaultFilterField("following_users")
     ...
     * Supported operators: `in`
     */
    public data object FollowingFeeds : FeedsFilterField, DefaultFilterField("following_feeds")
     ...
     */
    public data object FilterTags : FeedsFilterField, DefaultFilterField("filter_tags")

    /** Filter by any arbitrary field name not covered by the predefined filter fields. */
    public data class Raw(override val raw: String) : FeedsFilterField
}
