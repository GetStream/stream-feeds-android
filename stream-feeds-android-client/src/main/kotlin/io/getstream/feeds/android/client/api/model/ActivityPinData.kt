 ...
 *
 * This class contains all the information about an activity that has been pinned to a specific
 * feed, including the activity content, feed context, and timing information. Pinned activities are
 * typically displayed prominently at the top of feeds to highlight important or featured content.
 *
 * @property activity The activity that has been pinned. This property contains the full activity
 *   data for the pinned item, allowing access to all activity information including content,
 *   reactions, comments, and metadata without additional lookups.
 * @property createdAt The date and time when the activity was pinned to the feed.
 * @property fid The feed identifier where this activity is pinned. This property specifies which
 *   feed the activity is pinned to, as activities can be pinned to multiple feeds independently.
 ...
 * @property userId The identifier of the user who pinned the activity. This property tracks which
 *   user performed the pinning action, which is useful for permissions, auditing, and managing pin
 *   ownership.
 */
public data class ActivityPinData(
    ...
    /**
     * Unique identifier for the pinned activity, generated from the feed ID, activity ID, and user
     * ID. This identifier is used for simpler identification of pinned activities.
     */
