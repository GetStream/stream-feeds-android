...
/** Converts a [UsersQuery] to the corresponding [QueryUsersPayload]. */
internal fun UsersQuery.toRequest(): QueryUsersPayload =
    QueryUsersPayload(
        filterConditions = filter?.toRequest().orEmpty(),
