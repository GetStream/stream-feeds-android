 ...
 * @property limit Maximum number of bookmarks to return in a single request. If not specified,
...
public class BookmarksSort(field: BookmarksSortField, direction: SortDirection) :
  Sort<BookmarkData>(field, direction) {
    ...
    public companion object {
         ...
         */
        public val Default: List<BookmarksSort> = listOf(
            BookmarksSort(BookmarksSortField.CreatedAt, SortDirection.REVERSE)
        )
    }
  }
...
public sealed interface BookmarksSortField : SortField<BookmarkData> {
     ...
     */
    public data object CreatedAt : BookmarksSortField,
     ...
     */
    public data object UpdatedAt : BookmarksSortField,
