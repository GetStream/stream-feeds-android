...
public class ActivityReactionsSort(field: ActivityReactionsSortField, direction: SortDirection) :
    ...
    public companion object {
         ...
         */
        public val Default: List<ActivityReactionsSort> = listOf(
...
public sealed interface ActivityReactionsSortField : SortField<FeedsReactionData> {
     ...
     */
    public data object CreatedAt : ActivityReactionsSortField,
 ...
 *
 * This function maps the properties of the query to the corresponding request format
 * used by the Stream Feeds API.
 *
