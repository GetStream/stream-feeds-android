...
import io.getstream.feeds.android.client.internal.state.event.StateUpdateEvent.BookmarkUpserted
...
internal class ActivityEventHandlerTest(
    ...
    companion object {
        ...
        private val nonMatchingActivityBookmark =
            bookmarkData(activityData("other-activity", feeds = listOf(fid.rawValue)))
                ...
                testParams<ActivityStateUpdates>(
                    ...
                    event =
                        ActivityReactionUpserted(
                            fid.rawValue,
                            activity,
                            feedsReactionData("other-activity"),
                        ),
                    verifyBlock = { it wasNot called },
                ),
                testParams<ActivityStateUpdates>(
                ...
                testParams<ActivityStateUpdates>(
                    ...
                    event =
                        StateUpdateEvent.ActivityUpdated(
                            fid.rawValue,
                            activityData("other-activity"),
                        ),
                    verifyBlock = { it wasNot called },
                ),
                testParams<ActivityStateUpdates>(
                    name = "BookmarkUpserted matching feed and activity",
                    event = BookmarkUpserted(matchingBookmark),
                    verifyBlock = { it.onBookmarkUpserted(matchingBookmark) },
                ),
                testParams<ActivityStateUpdates>(
                    name = "BookmarkUpserted non-matching feed",
                    event = BookmarkUpserted(nonMatchingFeedBookmark),
                    verifyBlock = { it wasNot called },
                ),
                testParams<ActivityStateUpdates>(
                    name = "BookmarkUpserted non-matching activity",
                    event = BookmarkUpserted(nonMatchingActivityBookmark),
                    verifyBlock = { it wasNot called },
                ),
                testParams<ActivityStateUpdates>(
