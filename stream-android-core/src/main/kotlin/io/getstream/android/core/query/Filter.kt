 ...
 *
 * Filters are used to specify criteria for querying and retrieving data from Stream services.
 * Each filter implementation defines specific matching logic for different comparison operations.
 */
 ...
 */
public data class EqualFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 */
public data class GreaterThanFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 * @param value The threshold value for comparison
 */
public data class GreaterThanOrEqualFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 * @param value The threshold value for comparison
 */
public data class LessThanFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 * @param value The threshold value for comparison
 */
public data class LessThanOrEqualFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 */
public data class InFilter internal constructor(
    val field: String,
    val values: Set<Any>,
) : Filter()
 ...
 */
public data class QueryFilter internal constructor(
    val field: String,
    val value: String,
) : Filter()
 ...
 */
public data class AutocompleteFilter internal constructor(
    val field: String,
    val value: String,
) : Filter()
 ...
 */
public data class ExistsFilter internal constructor(
    val field: String,
    val value: Boolean,
) : Filter()
 ...
 */
public data class ContainsFilter internal constructor(
    val field: String,
    val value: Any,
) : Filter()
 ...
 */
public data class PathExistsFilter internal constructor(
    val field: String,
    val value: String,
) : Filter()
