package io.getstream.android.core.lifecycle
...
/**
 * A lifecycle observer that manages and notifies registered listeners about Android lifecycle events.
 * 
...
public class StreamLifecycleObserver(
    ...
    /**
     * Flag to track whether this is a recurring resume event.
     * Used to ignore the first resume event when initially observing the lifecycle.
     */
     ...
     * Notifies all registered listeners of the resume event, but ignores the first resume event
     * that occurs immediately after starting to observe the lifecycle.
     * 
     ...
     * Notifies all registered listeners of the stop event.
     * 
    ...
    /**
     * Subscribes a listener to receive lifecycle events.
     * If this is the first listener, the observer will start observing the lifecycle.
     * 
    ...
    /**
     * Unsubscribes a listener from receiving lifecycle events.
     * If this was the last listener, the observer will stop observing the lifecycle.
     * 
